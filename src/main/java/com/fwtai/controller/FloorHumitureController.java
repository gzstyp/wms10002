...
import com.fwtai.service.FloorHumitureService;
...
@RestController
@CrossOrigin
@RequestMapping("/floorHumiture")
public class FloorHumitureController{

    @Resource
    private FloorHumitureService service;
    ...
    //获取全部温湿度设备
    @GetMapping("allData")
    public void allData(final HttpServletResponse response){
        ToolClient.responseJson(service.allData(),response);
    }
}